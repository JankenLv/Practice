                    ...
                    <div class="row">
                        <div class="hidden-xs hidden-sm col-md-3">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default light" onclick="javascript:window.location.href='to_add';">
                ...
                <div class="panel-body pn">
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <tr class="message-unread">
                            ...
                            <td>
                                <form action="to_update/${emp.sn}" method="post" style="float: left;">
                                    <input type="hidden" name="_method" value="get">
                                    <input type="submit" value="编辑" style="border: none; color: #4babff; background: none;">
                                </form>
                                <form action="remove/${emp.sn}" method="post">
