    ...
    <div class="wrap">
        ...
        <c:choose>
            <c:when test="${USER != null}">
                <p class="welcome">大城市医院欢迎您！&nbsp;${USER}
                    &nbsp;
                    <a href="toService.do">进入管理系统</a>
                    &nbsp;
                    <a href="toLogout.do">退出登录</a>
                    &nbsp;
                    <a href="#3">帮助中心</a>
                </p>
            </c:when>
            <c:otherwise>
                <p class="welcome">欢迎来到大城市医院&nbsp;请&nbsp;
        ...
        <div class="item  detail_department clearfix">
            <div class="left">
                ...
                <c:forEach items="${SUBLIST}" var="cat">
                    <dl class="clearfix"><dt>${cat.name}</dt><dd>
                        <c:forEach items="${LIST}" var="dep">
                            <c:if test="${cat.id == dep.category.id}">
                                <a href="javascript:void(0)" class="item">${dep.name}</a>
                            </c:if>
                        </c:forEach>
                    </dd>
                    </dl>
