...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		function export03() {
		    $("#mainForm").attr({action:"${basePath}/ExportWord?version=03"}).submit();
        };
		function export07() {
		    $("#mainForm").attr({action:"${basePath}/ExportWord?version=07"}).submit();
        };
	</script>
	</head>
			...
			<div class="right">
				...
				<div class="rightCont">
					...
					<div style="text-align: center; margin-top: 30px;">
						<input class="tabSub" value="导出03" type="button" onclick="export03()"/>&nbsp;&nbsp;&nbsp;&nbsp;
						<input class="tabSub" value="导出07" type="button" onclick="export07()"/>
					</div>
				</div>
			</div>
		</form>
